        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(renderPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 721, Short.MAX_VALUE)
                    .addComponent(dataGenPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
...
//                data[i] = (int)(100f/Math.abs(Math.sin(Math.toRadians(20f*i/data.length*360f))));
    ...
    private void sortTypesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sortTypesActionPerformed
        if(sortTypes.getSelectedItem() == "Quick Sort"){
            animateSortButton.setVisible(false);
//            jSlider1.setVisible(false);
//            jButton2.setVisible(false);
        }else{
            animateSortButton.setVisible(true);
